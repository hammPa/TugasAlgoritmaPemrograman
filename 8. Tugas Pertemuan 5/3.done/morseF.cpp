/*
    namaTugas: Tugas ke 5 ALgoritma Pemrograman
    namaProgrammer: M.ilham(23343008)
    kasusProgram: program modular untuk menampilkan daftar kode morse
*/
...
void keHurufBesar(string *);
string keMorse(string kalimat, string morse[], string huruf);
void tampilkanHasil(string kalimat, string morse[], string huruf, string hasil);
...
int main(){
    ...
    tampilkanHasil(kalimat, morse, huruf, hasil);    
