/*
    ...
    kasusProgram: program modular untuk menampilkan bilangan prima Batas
*/
...
void input(int *, int *);
void proses(int awal, int akhir, int hasil[], int *);
...
void displayHasil(int awal, int akhir, int hasil[], int counterArr){
    cout << "Bilangan prima dari angka " << awal << " hingga " << akhir << " adalah : ";
